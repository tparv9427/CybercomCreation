...
<div class="product-card">
    <div class="product-image" onclick="window.location.href='<?php echo product_url($product); ?>'">
    ...
    <div class="product-info" onclick="window.location.href='<?php echo product_url($product); ?>'">
        <!-- Always visible -->
