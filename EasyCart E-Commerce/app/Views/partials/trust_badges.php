<?php
// Map badge keys to Label and SVG Icon
$badgeDefinitions = [
    'free_delivery' => [
        'label' => 'Free Delivery',
    ...
    'replacement' => [
        ...
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.5 2v6h-6M2.5 22v-6h6M2 11.5a10 10 0 0 1 18.8-4.3M22 12.5a10 10 0 0 1-18.8 4.2"/></svg>'
    ],
    'warranty' => [
    ...
    'easycart_delivered' => [
        'label' => 'EasyCart Delivered',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>'
    ]
];

if (isset($product['trust_badges']) && !empty($product['trust_badges'])): ?>
    <div class="trust-badges-container">
        <?php foreach ($product['trust_badges'] as $badgeKey):
            if (isset($badgeDefinitions[$badgeKey])):
                $badge = $badgeDefinitions[$badgeKey];
                ?>
