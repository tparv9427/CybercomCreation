...
<div class="container">
    ...
    <div class="order-filters">
        <a href="/orders?filter=active" class="filter-tab <?= ($filter === 'active' || !$filter) ? 'active' : '' ?>">Orders</a>
        <a href="/orders?filter=archived" class="filter-tab <?= ($filter === 'archived') ? 'active' : '' ?>">Archived</a>
    </div>
                    ...
                    <div class="order-details-drawer">
                        <div class="order-details-grid">
                            ...
                            <div class="order-actions-sidebar">
                                ...
                                <?php if ($isArchived): ?>
                                    <button class="action-btn" onclick="toggleArchive('<?= htmlspecialchars($order['order_number'] ?? $order['id']) ?>', false)">Unarchive order</button>
                                <?php else: ?>
                                    <button class="action-btn" onclick="toggleArchive('<?= htmlspecialchars($order['order_number'] ?? $order['id']) ?>', true)">Archive order</button>
                                <?php endif; ?>
                            </div>
                        </div>
